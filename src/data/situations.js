  ...
  'carriere-longue': {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Un **coefficient de solidarité de 10 %** s'appliquait pendant 3 ans (ou jusqu'à 67 ans) en cas de départ Agirc-Arrco avant taux plein. Ce dispositif a été supprimé : il ne s'applique plus aux retraites prenant effet à compter du 1er décembre 2023, et pour tous les autres retraités depuis le 1er avril 2024.\n\nVotre pension Agirc-Arrco n'est donc plus réduite selon votre âge de départ — seule votre pension de base (CNAV) reste soumise à une éventuelle décote si vous partez sans vos trimestres.",
      },
    ],
    faq: [
      ...
      { q: "Mon départ à 62 ans en carrière longue pénalise-t-il ma pension Agirc-Arrco ?", a: "Non, plus depuis avril 2024 : le coefficient de solidarité de 10 % qui s'appliquait auparavant a été supprimé. Votre pension Agirc-Arrco n'est plus réduite selon votre âge de départ. Simulez votre pension avec le simulateur retraite anticipée." },
    ],
  },
