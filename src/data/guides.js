...
export const GUIDES = [
  {
    ...
    steps: [
      ...
      { position: 4, name: 'Ouvrir et alimenter un PER', text: 'Le Plan d\'Épargne Retraite est l\'outil privilégié : déductible de l\'IR (jusqu\'à 38 448 €/an), bloqué jusqu\'à la retraite, et convertible en rente ou capital. Commencez le plus tôt possible pour bénéficier de l\'effet des intérêts composés.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { position: 2, name: "Maximiser les déductions du revenu imposable", text: "Le versement sur un PER est la déduction la plus universelle : jusqu'à 38 448 € (salarié, 2026), soit une économie de 38 448 × TMI. À 30 % de TMI = 11 534 € d'impôt économisé. Les frais réels professionnels peuvent remplacer l'abattement de 10 % si supérieurs." },
  ...
  },
  {
    ...
    steps: [
      ...
      { position: 2, name: 'Calculer sa pension complémentaire estimée', text: 'Utilisez le simulateur Agirc-Arrco de simfinly : entrez votre nombre de points actuels, votre salaire et votre âge de départ cible. La pension = points × valeur du point (1,4386 € en 2026). Additionnez votre CNAV pour obtenir la retraite totale.' },
      { position: 3, name: 'Le coefficient de solidarité n\'existe plus', text: 'Le malus de -10 % qui s\'appliquait autrefois en cas de départ Agirc-Arrco dès le taux plein CNAV a été supprimé (retraites liquidées depuis le 1er avril 2024). Votre pension complémentaire n\'est plus minorée selon votre âge de départ.' },
      { position: 4, name: 'Optimiser via la pension de base CNAV', text: 'Seule votre pension CNAV de base reste soumise à une décote (si départ avant le taux plein) ou une surcote (si départ après). Travailler plus longtemps augmente aussi votre pension Agirc-Arrco via les points supplémentaires accumulés.' },
      { position: 5, name: 'Planifier le moment de départ optimal', text: 'Le meilleur âge de départ dépend de votre situation personnelle : trimestres validés, décote/surcote CNAV, et nombre de points Agirc-Arrco accumulés. Le simulateur calcule automatiquement votre pension pour plusieurs scénarios d\'âge de départ.' },
    ],
  },
  {
