...
export const FAQS = {
  ...
  { q: "Combien vaut un point Agirc-Arrco en 2026 ?", a: "Deux valeurs coexistent et ne servent pas à la même chose. La valeur d'achat, ou salaire de référence, s'élève à 20,1877 € en 2026 : c'est le coût d'un point, elle détermine combien de points vos cotisations vous rapportent chaque année. La valeur de service, fixée à 1,4386 € en 2026, est ce que rapporte un point une fois à la retraite : 1 000 points valent donc 1 438,60 € brut par an. Les deux valeurs sont révisées chaque novembre par les partenaires sociaux." },
  { q: "Comment estimer sa retraite Agirc-Arrco sans connaître son nombre de points ?", a: "C'est le cas le plus fréquent en début ou milieu de carrière. Le simulateur reconstitue alors vos points à partir de votre salaire brut annuel et de votre nombre d'années de cotisation : il applique les taux de cotisation de la Tranche 1 et de la Tranche 2, puis divise par la valeur d'achat du point de chaque année. L'estimation est fiable pour une carrière régulière ; si votre salaire a fortement varié, récupérez plutôt votre nombre de points réel sur info-retraite.fr pour affiner." },
  ...
  { q: "Puis-je partir à la retraite avant 67 ans avec l'Agirc-Arrco ?", a: "Oui, dès 62 ans (ou 60 ans en carrière longue). Depuis la suppression du malus Agirc-Arrco (avril 2024), votre pension complémentaire n'est plus minorée si vous partez sans avoir atteint le taux plein — seule votre pension de base (CNAV) reste soumise à une éventuelle décote." },
  { q: "Comment sont revalorisés les points Agirc-Arrco chaque année ?", a: "Chaque novembre, les partenaires sociaux (syndicats et patronat) révisent la valeur de service du point. Elle évolue en principe comme l'inflation (indice des prix à la consommation hors tabac) pour préserver le pouvoir d'achat des retraités. En 2026, la valeur de service est fixée à 1,4386 €/point." },
  { q: "Le coefficient de solidarité de −10 % existe-t-il encore ?", a: "Non. Introduit en 2019, ce malus temporaire de 3 ans a été supprimé pour les retraites prenant effet à compter du 1er décembre 2023, et pour tous les retraités depuis le 1er avril 2024. La réforme des retraites 2023 (relèvement progressif de l'âge légal à 64 ans) a rendu ce dispositif obsolète." },
  ...
  { q: "D'où viennent les données de performance du comparateur ?", a: "Les cours historiques proviennent de Yahoo Finance, en prix ajustés (adjusted close) : ils intègrent les splits et les détachements de dividendes. Les données sont récupérées à la demande pour la période que vous choisissez, sans stockage de votre part." },
  { q: "Que signifie l'indice base 100 ?", a: "Pour comparer des actifs aux prix très différents (une action à 12 €, un ETF à 480 €, le bitcoin à des dizaines de milliers d'euros), chaque actif est ramené à 100 au début de la période. Une courbe à 180 signifie +80 % depuis le départ, quelle que soit la valeur absolue de l'actif." },
  { q: "Qu'est-ce que le CAGR affiché ?", a: "Le CAGR (Compound Annual Growth Rate) est le taux de croissance annualisé : le rendement annuel constant qui aurait produit la même performance totale sur la période. Il permet de comparer des périodes de longueurs différentes — +50 % en 3 ans et +50 % en 10 ans n'ont pas du tout le même CAGR." },
  { q: "Les dividendes sont-ils pris en compte ?", a: "Oui, de deux façons : les prix ajustés intègrent mécaniquement les détachements, et l'option « réinvestir les dividendes » simule leur réinvestissement systématique, ce qui reflète la performance d'un ETF capitalisant. Vous pouvez aussi afficher séparément les intérêts et dividendes générés." },
  { q: "Puis-je simuler des versements réguliers (DCA) ?", a: "Oui. En plus d'un capital initial, vous pouvez programmer des versements récurrents pour simuler une stratégie d'investissement progressif (DCA — Dollar Cost Averaging), et comparer son résultat entre plusieurs actifs sur la même période." },
  { q: "Les performances passées garantissent-elles les performances futures ?", a: "Non, jamais. Ce comparateur est un outil d'analyse historique : il montre ce qui s'est passé, pas ce qui se passera. Les calculs n'intègrent ni fiscalité, ni frais de gestion, ni inflation. Il ne constitue pas un conseil en investissement." },
],
  ...
  '/simulateurs/cnav': [
  { q: "Comment sont calculés les trimestres CNAV ?", a: "Un trimestre est validé pour chaque tranche de salaire équivalant à 150 fois le SMIC horaire brut, quel que soit le nombre de jours travaillés. Il faut gagner environ 1 782 € brut (150 × SMIC horaire 2026) par trimestre pour en valider un. On peut valider au maximum 4 trimestres par année civile." },
  ...
  { q: "Qu'est-ce que le minimum contributif ?", a: "Le minimum contributif (MICO) est un plancher de pension CNAV garanti aux assurés ayant cotisé toute leur carrière sur de faibles revenus, au taux plein. Il s'élève à environ 876 €/mois pour une carrière complète, porté à environ 963 €/mois (minimum contributif majoré) si vous avez cotisé au moins 120 trimestres. Ces montants sont revalorisés chaque année." },
  ...
  '/simulateurs/cnavpl': [
  { q: "Suis-je toujours affilié à la CIPAV ?", a: "Pas nécessairement. La réforme entrée en vigueur en 2019 a transféré les professions libérales non réglementées — consultants, formateurs, développeurs, la plupart des micro-entrepreneurs — vers le régime général des indépendants. La CIPAV ne conserve qu'une liste limitative d'une vingtaine de professions : architectes, géomètres-experts, ostéopathes, psychologues, psychothérapeutes, ergothérapeutes, diététiciens, guides-conférenciers, moniteurs de ski, guides de haute montagne, experts devant les tribunaux, artistes non affiliés à la Maison des artistes, entre autres. Vérifiez votre affiliation réelle sur votre appel de cotisations avant d'utiliser ce simulateur." },
  { q: "Quelle est la valeur du point CIPAV en 2026 ?", a: "Il faut distinguer les deux étages. Au régime de base commun aux professions libérales, la valeur de service du point s'établit à 0,6599 € par an en 2026. Au régime complémentaire propre à la CIPAV, la valeur de service atteint 2,89 € par an, pour un coût d'achat du point de 47,40 €. C'est cet écart qui explique que la complémentaire pèse bien plus lourd que la base dans la pension finale d'un libéral." },
  { q: "Comment fonctionnent les classes de cotisation CIPAV ?", a: "Le régime complémentaire de la CIPAV ne prélève pas un pourcentage de votre revenu mais une cotisation forfaitaire, déterminée par la classe à laquelle votre revenu professionnel vous rattache. Chaque classe correspond à un montant de cotisation et donc à un nombre de points acquis dans l'année. Il est possible d'opter volontairement pour une classe supérieure à celle imposée par votre revenu, afin d'acquérir davantage de droits — une option intéressante lors des bonnes années, puisque les cotisations restent déductibles du bénéfice imposable." },
  { q: "Pourquoi ma retraite de base de libéral est-elle si faible ?", a: "Parce qu'elle est plafonnée en points, pas seulement en revenus. Chaque tranche de cotisation ne peut générer qu'un nombre maximal de points par an — environ 550 pour la première tranche et 25 pour la seconde — quel que soit le revenu déclaré au-delà. Un libéral à hauts revenus n'acquiert donc pas plus de points de base qu'un confrère nettement moins bien rémunéré. C'est le régime complémentaire de votre section, et lui seul, qui différencie réellement les pensions." },
  ...
  { q: "Comment se calculent les points CNAVPL ?", a: "Le régime de base CNAVPL fonctionne par points depuis 2023. Chaque année, vous acquérez des points selon votre revenu : jusqu'à 557 points sur la tranche 1 (revenu jusqu'au PASS) et 25 points sur la tranche 2 (revenu du PASS à 5 fois le PASS), au prorata de vos cotisations. La pension annuelle = nombre total de points × valeur de service du point (0,6599 € en 2026)." },
  ...
  { q: "Comment est calculée la retraite de base des libéraux ?", a: "Contrairement au régime général, la retraite de base des professions libérales (CNAVPL) est un régime par points, pas un calcul sur le salaire annuel moyen. Vous accumulez des points chaque année selon votre revenu (jusqu'à 584 points/an : 557 en tranche 1, 25 en tranche 2). La pension = total des points × valeur de service (0,6599 € en 2026), minorée d'une décote de 0,625 % par trimestre manquant si vous partez avant le taux plein (67 ans ou durée requise atteinte)." },
  ...
  { q: "Ce simulateur convient-il aux enseignants et aux agents hospitaliers ?", a: "Oui. La formule de liquidation est la même pour les trois versants de la fonction publique : seule change la caisse qui verse la pension. Les enseignants de l'Éducation nationale, comme l'ensemble des fonctionnaires civils de l'État, relèvent du Service des retraites de l'État (SRE) ; les agents hospitaliers et territoriaux relèvent de la CNRACL. Dans tous les cas, saisissez votre traitement indiciaire brut mensuel, hors primes." },
  { q: "J'ai travaillé dans le privé puis dans la fonction publique : comment calculer ma retraite ?", a: "Chaque régime liquide sa propre pension et les montants s'additionnent : le régime général verse une retraite calculée sur vos 25 meilleures années, l'Agirc-Arrco sa complémentaire par points, et la fonction publique sa pension civile calculée sur le traitement de vos six derniers mois. La durée d'assurance s'apprécie en revanche tous régimes confondus pour déterminer votre décote ou votre surcote. Utilisez ce simulateur pour la part publique, puis notre synthèse retraite tous régimes pour additionner l'ensemble." },
  { q: "Puis-je racheter des trimestres d'études dans la fonction publique ?", a: "Oui, jusqu'à douze trimestres au titre des années d'études supérieures, auxquels peuvent s'ajouter les régularisations de services auxiliaires effectués avant la titularisation. Deux options existent : un rachat au titre du seul taux de liquidation, moins coûteux, ou un rachat au titre du taux et de la durée d'assurance. Le prix augmente avec l'âge et le traitement indiciaire. Le rachat n'est réellement rentable que s'il supprime une décote ou déclenche le taux plein." },
  { q: "Pourquoi ma pension nette est-elle inférieure au montant brut affiché ?", a: "La pension civile est versée brute puis diminuée de la CSG, de la CRDS et de la contribution de solidarité pour l'autonomie (Casa). Le taux appliqué dépend du revenu fiscal de référence de votre foyer : exonération totale pour les pensions les plus modestes, puis taux réduit, médian ou normal. Ce simulateur applique un taux de prélèvement médian par défaut ; votre net réel dépendra de votre situation fiscale." },
  { q: "La NBI est-elle prise en compte dans le calcul ?", a: "Non, pas dans la pension civile principale : celle-ci ne retient que le traitement indiciaire brut, hors primes, hors heures supplémentaires et hors nouvelle bonification indiciaire. La NBI ouvre en revanche droit à un supplément de pension spécifique, calculé à part et proportionnel aux points de NBI perçus et à leur durée. Les primes, elles, alimentent la RAFP, qui verse un complément distinct." },
  { q: "Et si j'ai travaillé à temps partiel ?", a: "Une période à temps partiel compte pour sa durée réelle dans la durée d'assurance mais est proratisée dans les trimestres liquidables, ce qui réduit la pension. Le dispositif de surcotisation permet de cotiser sur la base d'un temps plein pendant un temps partiel, afin que la période soit décomptée comme telle — dans la limite de quatre trimestres sur l'ensemble de la carrière, cette limite étant levée pour les agents en situation de handicap." },
],
  ...
  { q: "Comment valider des trimestres en tant qu'indépendant ?", a: "Un trimestre est validé pour chaque tranche de 600 SMIC horaires de revenu cotisé (soit environ 7 128 € en 2026). Il est donc possible de valider 4 trimestres avec un revenu annuel d'environ 28 512 €, même si ce revenu est inférieur au PASS." },
  ...
  { q: "Quelle est la valeur du point Ircantec en 2026 ?", a: "Deux valeurs coexistent. La valeur de service du point, celle qui détermine votre pension, s'élève à 0,56053 € par an au 1er janvier 2026 : 10 000 points rapportent donc 5 605,30 € brut par an. Le salaire de référence, autrement dit la valeur d'achat du point, s'établit lui à 5,787 € au 1er janvier 2026 : c'est le montant de cotisation nécessaire pour acquérir un point. Les deux sont revalorisés chaque année par le conseil d'administration du régime." },
  { q: "Comment calculer ses points Ircantec ?", a: "Pour chaque année, découpez votre rémunération en deux tranches par rapport au plafond de la Sécurité sociale (4 005 € par mois en 2026) : la tranche A sous le plafond, la tranche B au-dessus. Appliquez à chacune son taux théorique — 5,60 % en tranche A, 15,60 % en tranche B — puis divisez le résultat par le salaire de référence de l'année. Le total des points de toutes vos années, multiplié par la valeur de service, donne votre pension annuelle. Les cotisations réellement retenues sur votre paie sont supérieures aux taux théoriques : ce surplus finance le régime sans créer de points." },
  { q: "Quelle différence entre la tranche A et la tranche B ?", a: "La tranche A correspond à la part de votre rémunération inférieure au plafond de la Sécurité sociale, la tranche B à la part comprise entre une et huit fois ce plafond. La tranche B est bien plus généreuse en points, son taux théorique de 15,60 % étant près de trois fois supérieur à celui de la tranche A. Un agent contractuel dont la rémunération dépasse le plafond accumule donc proportionnellement beaucoup plus de droits sur la part haute de son salaire." },
  { q: "Les élus locaux cotisent-ils à l'Ircantec ?", a: "Oui. Les maires, adjoints, conseillers municipaux indemnisés, conseillers départementaux et régionaux cotisent à l'Ircantec au titre de leurs indemnités de fonction, selon les mêmes règles de calcul par points que les agents contractuels. Ces droits s'ajoutent à ceux acquis dans leur activité professionnelle et leur restent définitivement acquis, y compris après la fin du mandat. Ce simulateur s'applique donc aussi à eux : saisissez le montant brut de vos indemnités." },
  { q: "Que deviennent mes points si je quitte le secteur public ?", a: "Ils vous restent acquis définitivement. Les points Ircantec ne sont ni perdus, ni transférés vers un autre régime, ni convertis : ils sont simplement mis en réserve jusqu'à votre départ en retraite, où ils donneront lieu à une pension propre, versée par l'Ircantec en plus de vos autres retraites. Si vous êtes titularisé par la suite, vos périodes de contractuel restent couvertes par l'Ircantec et votre période de titulaire relèvera du SRE ou de la CNRACL." },
  ...
  { q: "Comment fonctionne le régime par points IRCANTEC ?", a: "Chaque année, vos cotisations (salarié + employeur) sont divisées par la valeur d'achat du point (5,787 € au 1er janvier 2026) pour obtenir un nombre de points. À la retraite, ces points sont multipliés par la valeur de service du point (0,56053 €/point/an en 2026) pour calculer votre pension annuelle complémentaire." },
  ...
  {
    q: "Comment calculer sa pension de réversion ?",
    a: "Reprenez le montant de la retraite que percevait le défunt, régime par régime, puis appliquez à chacun le taux correspondant : 54 % sur la retraite de base du régime général, 60 % sur la complémentaire Agirc-Arrco, 50 % sur une pension de fonctionnaire ou d'Ircantec. Retranchez ensuite, pour la seule base du régime général, le dépassement éventuel du plafond de ressources. Le total des réversions de chaque caisse constitue votre pension de réversion mensuelle : c'est exactement l'enchaînement que reproduit ce simulateur.",
  },
  {
    q: "Le calcul est-il le même à la MSA, à la Carsat ou à la Sécurité sociale des indépendants ?",
    a: "Oui. Les Carsat sont simplement les caisses régionales du régime général : le calcul est celui de la CNAV. La MSA (salariés et non-salariés agricoles) et la Sécurité sociale des indépendants (artisans, commerçants, ex-RSI) sont des régimes alignés : même taux de 54 %, même condition de ressources, même âge minimum de 55 ans. Vous pouvez donc utiliser l'option « salarié du privé » du simulateur pour ces trois situations.",
  },
  {
    q: "Et pour un régime spécial (SNCF, RATP, IEG) ou une profession libérale ?",
    a: "Ces régimes conservent leurs propres règles et ne sont pas reproduits ici. Les régimes spéciaux (SNCF, RATP, industries électriques et gazières, Banque de France) et les caisses de professions libérales (CNAVPL et ses sections dont la CIPAV, CARMF pour les médecins, CNBF pour les avocats) fixent chacun leur taux, leur âge minimum et leurs conditions. Le simulateur reste utile pour estimer la part du défunt relevant du régime général ou de la fonction publique ; pour la part relevant d'un régime spécial, adressez-vous directement à la caisse concernée.",
  },
  {
    q: "Les règles de la réversion ont-elles changé ces dernières années ?",
    a: "Les taux (54 %, 60 %, 50 %) et l'âge minimum de 55 ans au régime général n'ont pas bougé depuis plusieurs années. Ce qui change chaque année, c'est le plafond de ressources du régime général, revalorisé au 1er janvier : il s'établit à 25 001,60 € par an pour une personne seule en 2026. Une simulation faite avec un plafond de 2020, 2021 ou 2023 donne donc un montant de réversion différent à situation identique — ce simulateur applique le plafond 2026 en vigueur.",
  },
  {
    q: "La pension de réversion est-elle imposable ?",
    a: "Oui. La pension de réversion est imposée comme une pension de retraite : elle entre dans le revenu imposable du conjoint survivant, après l'abattement de 10 % applicable aux pensions. Elle supporte également la CSG, la CRDS et la Casa, à un taux qui dépend du revenu fiscal de référence du foyer — avec exonération totale pour les revenus les plus modestes. Attention : la réversion perçue compte aussi dans les ressources prises en compte pour le plafond du régime général.",
  },
  {
    q: "Ce simulateur est-il officiel ?",
  ...
  { q: "Quel est le barème des droits de succession en 2026 ?", a: "En ligne directe — entre parents et enfants —, la part taxable après abattement est soumise à un barème progressif : 5 % jusqu'à 8 072 €, 10 % jusqu'à 12 109 €, 15 % jusqu'à 15 932 €, 20 % jusqu'à 552 324 €, 30 % jusqu'à 902 838 €, 40 % jusqu'à 1 805 677 € et 45 % au-delà. Hors ligne directe, les taux sont bien plus lourds : 35 % puis 45 % entre frères et sœurs, 55 % pour les neveux et nièces, 60 % pour toute autre personne, concubin compris." },
  { q: "Combien de droits pour une succession de 300 000 € entre deux enfants ?", a: "Chaque enfant reçoit 150 000 € et applique son abattement de 100 000 €, ce qui laisse 50 000 € taxables. Le barème progressif s'applique alors par tranches : 5 % sur les 8 072 premiers euros, 10 % sur la tranche suivante, 15 % sur la troisième, puis 20 % sur le solde, soit environ 8 200 € de droits par enfant. Le taux réellement supporté avoisine donc 5,5 % de la part reçue, très loin des 20 % de la tranche atteinte — c'est tout l'effet de la progressivité." },
  { q: "L'assurance-vie entre-t-elle dans la succession ?", a: "Non, en principe. Les capitaux versés aux bénéficiaires désignés dans la clause bénéficiaire échappent à l'actif successoral et relèvent d'une fiscalité propre. Pour les primes versées avant les 70 ans de l'assuré, chaque bénéficiaire profite d'un abattement de 152 500 €, puis d'une taxation de 20 % jusqu'à 700 000 € et de 31,25 % au-delà. Pour les primes versées après 70 ans, seules celles-ci — et non les gains — réintègrent la succession, après un abattement global de 30 500 € tous bénéficiaires confondus." },
  { q: "Qui paie les droits de succession et dans quel délai ?", a: "Chaque héritier est redevable des droits portant sur sa propre part. La déclaration de succession doit être déposée dans les six mois suivant le décès lorsqu'il est survenu en France — douze mois depuis l'étranger — et le paiement est en principe exigible au dépôt. Un retard entraîne un intérêt de retard et une majoration. Des facilités existent : le paiement fractionné sur plusieurs années, ou le paiement différé lorsque la succession comporte des biens démembrés, sous conditions et généralement contre garanties." },
  ...
  { q: "Qu'est-ce que le minimum contributif ?", a: "Le minimum contributif (MICO) garantit une pension de base CNAV minimale pour ceux qui ont cotisé toute leur carrière avec de faibles salaires, au taux plein. Il s'élève à environ 876 €/mois pour une carrière complète, porté à environ 963 €/mois (minimum contributif majoré) si vous avez cotisé au moins 120 trimestres. Ces montants sont revalorisés chaque année." },
