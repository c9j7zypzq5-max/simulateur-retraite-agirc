...
export const METIERS = {
  ...
  fonctionnaire: {
    ...
    metaTitle: 'Retraite fonctionnaire 2026 — âge de départ, montant et conditions',
    metaDesc: "À quel âge partir et quelle pension espérer selon votre versant : État (SRE), territorial ou hospitalier (CNRACL), catégorie active ou sédentaire. Guide 2026.",
    ...
    sections: [
      ...
      {
        title: "État, territorial, hospitalier : quel régime pour quel agent",
        content: "Le versant détermine la caisse, pas la formule. Les fonctionnaires civils et militaires de l'État — enseignants, policiers, magistrats, diplomates — relèvent du **Service des retraites de l'État (SRE)**. Les agents titulaires des communes, départements, régions et intercommunalités, ainsi que les personnels des hôpitaux publics, relèvent de la **CNRACL**.\n\nLes règles de liquidation sont identiques de part et d'autre : traitement des six derniers mois, durée de référence, décote, surcote, taux maximum de 75 %. Ce qui diffère, ce sont les grilles indiciaires, la part des primes dans la rémunération et la fréquence du classement en catégorie active — nettement plus répandu dans l'hospitalière et dans certains cadres d'emplois territoriaux.",
      },
      {
        title: "Combien touche un fonctionnaire à la retraite ?",
        content: "La pension vaut le traitement indiciaire brut des six derniers mois multiplié par le taux de liquidation, plafonné à 75 %. Un agent dont le traitement de fin de carrière atteint 3 000 € brut par mois avec la durée complète perçoit donc environ 2 250 € brut de pension civile.\n\nDeux corrections s'appliquent ensuite. Les **primes ne comptent pas** dans la pension de base : plus votre rémunération en dépendait, plus la baisse est brutale au moment du départ — c'est le RAFP, alimenté par ces primes dans la limite de 20 % du traitement, qui compense partiellement. Et la CSG, la CRDS et la Casa réduisent le brut d'un pourcentage variable selon votre revenu fiscal de référence. Un agent très primé peut ainsi voir son revenu chuter davantage qu'un salarié du privé à rémunération équivalente.",
      },
      {
    ...
    faq: [
      ...
      { q: "Quelle différence entre le SRE et la CNRACL ?", a: "Ce sont deux caisses distinctes appliquant les mêmes règles de liquidation. Le Service des retraites de l'État gère les fonctionnaires civils et militaires de l'État, la CNRACL les agents titulaires des collectivités territoriales et de la fonction publique hospitalière. Traitement des six derniers mois, durée de référence, décote, surcote et taux maximum de 75 % sont identiques dans les deux cas : seules les grilles indiciaires et la fréquence du classement en catégorie active diffèrent réellement." },
      { q: "Combien touche un fonctionnaire à la retraite ?", a: "La pension civile correspond au traitement indiciaire brut des six derniers mois multiplié par le taux de liquidation, au maximum 75 %. Avec un traitement de fin de carrière de 3 000 € brut et une carrière complète, elle avoisine 2 250 € brut par mois, avant CSG, CRDS et Casa. Attention : les primes n'entrent pas dans ce calcul et n'alimentent que le RAFP, si bien qu'un agent fortement primé subit une baisse de revenu plus marquée qu'un salarié du privé à rémunération comparable." },
  ...
  infirmiere: {
    ...
    sections: [
      ...
      {
        title: "Catégorie A ou catégorie B : le choix de 2010",
        content: "La réforme de 2010 a placé les infirmières hospitalières devant un choix irréversible. Rester en **catégorie B** conservait le classement en catégorie active, donc le droit au départ anticipé à 57 ans à l'époque — 59 ans après la réforme de 2023. Basculer en **catégorie A** signifiait une grille indiciaire revalorisée, donc un meilleur traitement de fin de carrière et une pension plus élevée, mais la perte du classement actif et un départ aligné sur l'âge de droit commun.\n\nCe choix continue de produire ses effets aujourd'hui : deux infirmières de la même promotion peuvent partir à cinq ans d'écart avec des pensions sensiblement différentes. Les infirmières recrutées après 2010 sont directement en catégorie A, donc sédentaires.",
      },
      {
        title: "Combien touche réellement une infirmière à la retraite ?",
        content: "Le montant se déduit de la formule, pas d'une moyenne. À l'hôpital public, la pension vaut le traitement indiciaire brut des six derniers mois multiplié par le taux de liquidation — au maximum 75 %. Une infirmière en fin de carrière dont le traitement indiciaire brut atteint 2 800 € par mois et qui réunit la durée complète percevra donc de l'ordre de 2 100 € brut de pension civile, avant prélèvements sociaux et avant RAFP.\n\nDeux facteurs font baisser ce montant dans la réalité : les **primes ne comptent pas** dans la pension de base — elles n'alimentent que le RAFP —, et une carrière incomplète applique une proratisation, à laquelle peut s'ajouter une décote. En libéral, le raisonnement est tout autre : la pension dépend des points CARPIMKO accumulés, donc du niveau de revenus déclarés sur l'ensemble de la carrière.",
      },
      {
    ...
    faq: [
      ...
      { q: "Quel est le montant de la retraite d'une infirmière hospitalière ?", a: "Il se calcule à partir du traitement indiciaire brut des six derniers mois, hors primes, multiplié par le taux de liquidation plafonné à 75 %. Avec un traitement de fin de carrière de 2 800 € brut et une durée complète, la pension civile ressort autour de 2 100 € brut par mois, à laquelle s'ajoute le complément RAFP issu des primes. Une carrière incomplète réduit ce montant par proratisation, et une décote s'applique en cas de départ sans la durée requise." },
      { q: "Infirmière catégorie A ou catégorie B : quelle différence à la retraite ?", a: "La catégorie B conserve le classement en catégorie active : départ possible à 59 ans après 17 ans de services actifs, mais sur une grille indiciaire moins favorable. La catégorie A offre une grille revalorisée, donc un meilleur traitement de fin de carrière et une pension plus élevée, mais un départ aligné sur l'âge de droit commun. Les infirmières recrutées depuis 2010 relèvent directement de la catégorie A." },
      { q: "Comment calculer sa retraite d'infirmière ?", a: "Tout dépend de votre statut. À l'hôpital public, utilisez le simulateur de la fonction publique en saisissant votre traitement indiciaire brut mensuel hors primes. En clinique privée ou en EHPAD associatif, combinez le simulateur CNAV pour la base et le simulateur Agirc-Arrco pour la complémentaire. En libéral, la retraite relève de la CARPIMKO, section de la CNAVPL : le simulateur des professions libérales en donne l'ordre de grandeur." },
  ...
  enseignant: {
    ...
    sections: [
      ...
      {
        title: "Combien touche un professeur des écoles à la retraite ?",
        content: "Le calcul part du **traitement indiciaire brut des six derniers mois**, hors toute prime. Un professeur des écoles terminant sa carrière à la hors-classe, avec un traitement indiciaire brut de l'ordre de 3 200 € par mois et la durée d'assurance complète, perçoit environ 2 400 € brut de pension civile — soit 75 % de son traitement de référence.\n\nÀ ce montant s'ajoute le RAFP, modeste dans l'enseignement puisque les primes y sont faibles, et se retranchent la CSG, la CRDS et la Casa. Une carrière incomplète — service national non validé, années de vacation, disponibilité, temps partiel — proratise la pension et peut déclencher une décote de 0,625 % par trimestre manquant.",
      },
      {
        title: "1er degré, 2nd degré, agrégés : ce qui change vraiment",
        content: "La formule de liquidation est rigoureusement identique pour tous les corps enseignants : c'est le **traitement indiciaire de fin de carrière** qui fait toute la différence. Un professeur des écoles et un certifié partagent aujourd'hui la même grille indiciaire, donc des pensions comparables à échelon égal.\n\nUn agrégé, en revanche, culmine à un indice nettement supérieur, ce qui se répercute directement et définitivement sur sa pension. C'est aussi pourquoi accéder à la hors-classe ou à la classe exceptionnelle en fin de carrière pèse lourd : l'indice détenu pendant les six derniers mois est celui qui sert de base au calcul, quel que soit le déroulé des années précédentes.",
      },
      {
    ...
    faq: [
      ...
      { q: "Quel est le montant de la retraite d'un professeur des écoles ?", a: "Avec un traitement indiciaire brut de fin de carrière de l'ordre de 3 200 € par mois à la hors-classe et une durée d'assurance complète, la pension civile ressort autour de 2 400 € brut mensuels, soit 75 % du traitement de référence. S'y ajoute le RAFP, faible dans l'enseignement où les primes sont peu élevées, et s'en retranchent la CSG, la CRDS et la Casa. Une carrière incomplète réduit ce montant par proratisation et éventuelle décote." },
      { q: "Pourquoi ma pension d'enseignant est-elle plus faible que mon dernier salaire ?", a: "Pour deux raisons cumulées. D'abord la pension ne peut excéder 75 % du traitement de référence, même avec une carrière complète. Ensuite, et surtout, elle ne retient que le traitement indiciaire brut : l'ISOE, les heures supplémentaires, l'indemnité REP ou REP+ et la prime de direction en sont exclues. Ces primes n'alimentent que le RAFP, dont le rendement reste modeste. Plus la part de primes est élevée dans votre rémunération, plus la chute au moment du départ est marquée." },
      { q: "L'indice de fin de carrière compte-t-il vraiment autant ?", a: "Oui, c'est le paramètre décisif. La pension est calculée sur l'indice majoré détenu pendant au moins six mois avant le départ, sans aucune moyenne sur la carrière — contrairement au privé, où l'on retient les 25 meilleures années. Un passage à la hors-classe ou à la classe exceptionnelle même tardif se répercute donc intégralement et définitivement sur la pension, ce qui rend l'année de départ stratégique." },
  ...
  pharmacien: {
    ...
    sections: [
      ...
      {
        title: "La retraite complémentaire des pharmaciens en détail",
        content: "C'est l'étage qui pèse le plus lourd dans la pension d'un pharmacien titulaire, et le plus singulier du paysage français. Le régime complémentaire de la **CAVP** ne fonctionne pas uniquement par répartition : il comporte une part obligatoire gérée par **capitalisation**, où les cotisations versées constituent un capital individuel qui vous appartient et sera converti en rente au moment du départ. La CAVP est la seule caisse de profession libérale à avoir généralisé ce mécanisme.\n\nConcrètement, votre complémentaire additionne deux composantes : des points acquis par répartition, valorisés comme dans les autres régimes, et une rente issue de votre compte de capitalisation, dont le montant dépend des sommes versées et de leur rendement financier. Cette architecture explique pourquoi deux pharmaciens ayant cotisé au même niveau peuvent percevoir des complémentaires différentes selon leur année de liquidation.",
      },
      {
    ...
    faq: [
      ...
      { q: "Comment fonctionne la retraite complémentaire des pharmaciens ?", a: "Le régime complémentaire de la CAVP combine deux mécanismes. Une part fonctionne par répartition, sur le modèle classique des points : vos cotisations achètent des points, convertis en rente à la liquidation. Une autre part, obligatoire, fonctionne par capitalisation : les sommes versées alimentent un compte individuel qui vous est propre et qui sera converti en rente au départ. La CAVP est la seule section de profession libérale à avoir généralisé ce système, qui constitue l'essentiel de la pension d'un titulaire." },
      { q: "Quelle retraite pour un pharmacien salarié adjoint ?", a: "Un pharmacien adjoint salarié ne relève pas de la CAVP mais du régime général : retraite de base CNAV calculée sur les 25 meilleures années, complétée par l'Agirc-Arrco au titre du statut cadre. Ses règles sont donc celles de n'importe quel salarié cadre du privé, sans capitalisation obligatoire. Un pharmacien ayant alterné salariat et exercice en officine cumule des droits dans les deux systèmes, chaque caisse versant sa propre pension." },
