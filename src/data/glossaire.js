...
export const GLOSSARY = [
  ...
  },
  {
    ...
    long: [
      "L'apport personnel est la part du projet payée sans emprunter (épargne, donation, PEL, déblocage de participation…). Les banques demandent en général au moins 10 % du prix pour couvrir les frais de notaire et de garantie, même si des prêts à 100 % ou 110 % existent pour les profils solides.",
      "Un apport élevé a trois effets : il rassure la banque (meilleur dossier), peut faire baisser le taux proposé, et réduit mécaniquement le montant emprunté — donc le coût total du crédit en intérêts.",
      "Exemple : pour un achat à 250 000 € avec 25 000 € de frais annexes (notaire, garantie), un apport de 35 000 € couvre les frais et laisse un emprunt de 240 000 € au lieu de 275 000 € sans apport — plusieurs dizaines de milliers d'euros d'intérêts économisés sur 20 ans.",
      "Le Prêt à Taux Zéro (PTZ) peut compléter un apport insuffisant pour un premier achat, sous conditions de ressources et de zone géographique.",
    ],
    sims: ['/simulateurs/emprunt-immobilier', '/simulateurs/ptz'],
    related: ['frais-notaire', 'capacite-emprunt'],
    faqs: [
      { q: "Quel apport minimum pour un prêt immobilier ?", a: "En pratique, les banques demandent le plus souvent un apport couvrant au moins les frais annexes (notaire, garantie, dossier), soit environ 10 % du prix d'achat. Un apport plus important (15-20 %) facilite l'obtention du prêt et peut permettre de négocier un meilleur taux." },
      { q: "Peut-on emprunter sans apport personnel ?", a: "Oui, certaines banques financent à 100 %, voire 110 % (prix + frais), notamment pour les jeunes actifs avec des revenus stables ou dans le cadre d'un investissement locatif. Le dossier doit alors être particulièrement solide (taux d'endettement maîtrisé, épargne résiduelle après achat)." },
    ],
  },
  {
    ...
    faqs: [
      { q: "Quel est le montant des frais de notaire pour un achat dans l'ancien ?", a: "Les frais de notaire dans l'ancien représentent environ 7 à 8 % du prix d'achat. Ils se décomposent en : droits de mutation (6,32 % dans la majorité des départements depuis la hausse votée en 2025, contre 5,81 % dans une minorité de départements n'ayant pas relevé leur taux, et un cas particulier à ~5,09 % pour l'Indre et Mayotte), débours (~0,5-1 %), émoluments du notaire (~0,8 %) et autres taxes. Sur un bien à 300 000 €, comptez environ 21 000-24 000 €." },
  ...
  },
  {
    ...
    long: [
      "Dans un prêt amortissable (le format standard en France), chaque mensualité constante rembourse une part d'intérêts et une part de capital. Le tableau d'amortissement détaille cette répartition mois par mois jusqu'au remboursement intégral.",
      "En début de prêt, la part d'intérêts domine car ils sont calculés sur un capital restant dû encore élevé ; elle diminue progressivement tandis que la part de capital augmente à mensualité égale.",
      "Exemple : sur un prêt de 200 000 € sur 20 ans à 3,5 %, la première mensualité (~1 160 €) contient environ 580 € d'intérêts et 580 € de capital ; la dernière mensualité contient presque uniquement du capital.",
      "Cette mécanique explique pourquoi un remboursement anticipé en début de prêt fait économiser beaucoup plus d'intérêts qu'un remboursement anticipé en fin de prêt.",
    ],
    sims: ['/simulateurs/emprunt-immobilier', '/simulateurs/credit-conso'],
  ...
  },
  {
    ...
    long: [
      "La CSG est un prélèvement social assis sur les revenus d'activité, de remplacement (retraites, chômage) et du capital. Son taux varie selon la nature du revenu : 9,2 % sur les salaires, et un barème progressif selon le revenu fiscal de référence (RFR) pour les pensions de retraite (exonération, 3,8 %, 6,6 % ou 8,3 % en 2026).",
      "Une partie de la CSG est déductible du revenu imposable (5,9 points sur les 9,2 % des salaires, par exemple), ce qui réduit d'autant l'impôt sur le revenu dû l'année suivante.",
      "Sur les pensions de retraite, la CSG s'accompagne de la CRDS (0,5 %) et, aux taux médian et normal, de la CASA (0,3 %) — soit un total de 0 %, 4,3 %, 7,4 % ou 9,1 % selon le RFR du foyer.",
    ],
    sims: ['/simulateurs/salaire', '/simulateurs/impot-revenu', '/simulateurs/cnav'],
    related: ['crds', 'prelevements-sociaux', 'rfr'],
  },
  {
  ...
  },
  {
    ...
    long: [
      "Un abattement diminue le montant soumis à l'impôt, contrairement à une réduction ou un crédit d'impôt qui s'applique après calcul de l'impôt. Il peut être forfaitaire (10 % sur les salaires, 50 % en micro-BIC, 30 % en micro-foncier) ou progressif selon une durée de détention (plus-values immobilières ou mobilières).",
      "L'assurance-vie bénéficie d'un abattement annuel sur les gains après 8 ans de détention : 4 600 € pour une personne seule, 9 200 € pour un couple soumis à imposition commune — au-delà, les gains restent taxés au barème choisi.",
      "En succession et donation, l'abattement en ligne directe (parent-enfant) est de 100 000 € par enfant, renouvelable tous les 15 ans — c'est le principal levier de transmission sans droits.",
    ],
    sims: ['/simulateurs/assurance-vie', '/simulateurs/plus-value-immobiliere', '/simulateurs/succession'],
  ...
  },
  {
    ...
    long: [
      "En matière de retraite, le PASS délimite les tranches de cotisation Agirc-Arrco : la tranche 1 va de 0 à 1 PASS (48 060 €/an), la tranche 2 de 1 à 8 PASS (384 480 €/an). Chaque tranche a son propre taux de cotisation, donc son propre rendement en points.",
      "Il plafonne aussi le Salaire Annuel Moyen (SAM) retenu pour le calcul de la pension CNAV : un revenu au-delà du PASS une année donnée n'est pas compté au-delà de ce montant pour cette année-là.",
      "Exemple : un cadre gagnant 60 000 €/an cotise sur la totalité en tranche 1 (48 060 €) et sur 11 940 € en tranche 2 — les deux tranches génèrent des points à des taux différents.",
      "Pour l'usage fiscal et social plus large du PASS (plafond PER, indemnités…), voir l'entrée dédiée.",
    ],
    sims: ['/simulateurs/agirc-arrco', '/simulateurs/cnav', '/simulateurs/per'],
    related: ['per', 'smic'],
  },
  {
  ...
  },
  {
    ...
    long: [
      "La décote s'applique quand on part à la retraite avant d'avoir le taux plein (trimestres insuffisants et avant 67 ans). Pour le régime général (CNAV), elle est de 0,625 % par trimestre manquant, plafonnée à 20 trimestres — soit 12,5 % de réduction maximum. Elle est calculée sur le taux de la pension, pas sur son montant final.",
      "Exemple : il manque 8 trimestres pour le taux plein → décote de 8 × 0,625 % = 5 %. Sur une pension de base de 1 200 €/mois, cela représente 60 €/mois perdus, à vie.",
      "La décote est indépendante de la retraite complémentaire Agirc-Arrco, qui n'applique plus aucune minoration liée à l'âge de départ depuis avril 2024 (fin du coefficient de solidarité).",
    ],
    sims: ['/simulateurs/cnav', '/simulateurs/agirc-arrco'],
    related: ['taux-plein', 'surcote', 'trimestre'],
    faqs: [
      { q: "La décote s'applique-t-elle aussi à la retraite complémentaire Agirc-Arrco ?", a: "Non, plus depuis le 1er avril 2024 : le coefficient de solidarité qui minorait la pension Agirc-Arrco a été supprimé. Seule la pension de base CNAV reste soumise à une décote." },
      { q: "La décote disparaît-elle avec le temps ?", a: "Non, elle est définitive : le coefficient réduit s'applique à vie sur la pension de base, dès la première liquidation et jusqu'au décès." },
    ],
  },
  {
    ...
    long: [
      "La surcote augmente la pension de base (CNAV) lorsqu'on continue à travailler après avoir atteint à la fois l'âge légal et le nombre de trimestres requis. Chaque trimestre supplémentaire cotisé majore la pension de 1,25 %, sans plafond légal.",
      "Exemple : 8 trimestres travaillés après le taux plein → +8 × 1,25 % = +10 % sur la pension de base. Sur une pension de 1 400 €/mois, cela représente 140 €/mois de plus, à vie.",
      "Contrairement à la décote, la surcote n'a pas d'équivalent limité dans le temps du côté Agirc-Arrco : les trimestres travaillés en plus génèrent simplement des points supplémentaires, qui s'ajoutent normalement au calcul de la pension complémentaire.",
    ],
  ...
  },
  {
    ...
    long: [
      "Les trimestres se valident par les cotisations (un trimestre par tranche de revenu équivalente à 150 fois le SMIC horaire, soit environ 1 782 € en 2026) ou par des périodes assimilées (maladie, chômage indemnisé, maternité, service militaire…). Maximum 4 trimestres validés par année civile, quel que soit le nombre réellement travaillé.",
      "Le nombre requis pour le taux plein dépend de l'année de naissance : il est resté fixé à 172 trimestres (43 ans) pour les générations 1965 et suivantes par la loi Touraine de 2014, mais le calendrier de relèvement de l'âge légal a été temporairement modifié par la LFSS 2026 pour les générations 1964-1968.",
      "Consultez votre Relevé de Situation Individuelle sur info-retraite.fr pour connaître votre nombre exact de trimestres validés.",
    ],
    sims: ['/simulateurs/cnav', '/simulateurs/trimestres'],
  ...
  },
  {
    ...
    long: [
      "Un ETF, ou tracker, est un fonds qui réplique passivement la performance d'un indice boursier plutôt que de chercher à le battre. Ses frais de gestion annuels sont très faibles (souvent 0,05 % à 0,30 %) comparés aux fonds actifs traditionnels (1,5 % à 2,5 %), ce qui fait une différence considérable sur le long terme.",
      "Les ETF World (actions mondiales) ou S&P 500 (actions américaines) sont des supports courants pour un investissement long terme diversifié, logeables en PEA (ETF européens uniquement) ou en assurance-vie/PER (toutes zones géographiques via unités de compte).",
      "Exemple : sur 20 ans, un écart de frais de 1,5 %/an entre un ETF (0,2 %) et un fonds actif (1,7 %) réduit le capital final d'environ 20 % à performance brute égale — la baisse de frais est un des seuls leviers garantis en investissement.",
    ],
    sims: ['/simulateurs/comparateur', '/simulateurs/epargne'],
  ...
  },
  {
    ...
    long: [
      "Avec les intérêts composés, les gains d'une période s'ajoutent au capital et produisent à leur tour des gains lors de la période suivante. L'effet « boule de neige » devient spectaculaire sur le long terme : la croissance n'est pas linéaire mais exponentielle.",
      "Exemple concret : 10 000 € placés à 6 %/an sans aucun versement complémentaire deviennent environ 18 000 € après 10 ans, mais plus de 57 000 € après 30 ans — le capital n'a été multiplié « que » par 1,8 en 10 ans, mais par 5,7 en 30 ans, car les intérêts des premières années continuent de composer sur toute la durée restante.",
      "C'est le moteur principal de la constitution d'un patrimoine à long terme : plus on commence tôt, plus l'effet est puissant, ce qui explique pourquoi le temps compte souvent plus que le montant investi.",
    ],
  ...
  },
  {
    ...
    long: [
      "Le taux d'épargne = épargne mensuelle / revenus nets. C'est le facteur qui influence le plus la vitesse à laquelle on construit un patrimoine — davantage que le rendement des placements, surtout dans les premières années.",
      "La règle 50/30/20 suggère d'y consacrer au moins 20 % des revenus (50 % besoins essentiels, 30 % envies, 20 % épargne/dette). Les adeptes du mouvement FIRE visent souvent 40 à 60 %.",
      "Exemple d'impact sur la durée jusqu'à l'indépendance financière (à rendement constant) : à 10 % de taux d'épargne, il faut environ 51 ans pour atteindre un capital couvrant les dépenses ; à 25 %, environ 32 ans ; à 50 %, environ 17 ans. Doubler son taux d'épargne ne divise pas seulement le temps par deux : il le réduit bien davantage, car chaque euro épargné en plus réduit aussi les dépenses cibles.",
    ],
  ...
  },
  {
    ...
    long: [
      "Le PEL est un produit d'épargne réglementé destiné à préparer un achat immobilier. Il offre un taux de rémunération garanti, fixé définitivement à l'ouverture du plan, et — après une phase d'épargne minimale de 4 ans — un droit à un prêt immobilier à un taux connu d'avance, indépendant des conditions de marché futures.",
      "Versement minimum de 225 €/an pendant 4 ans minimum, plafond de versements de 61 200 €. Durée de vie maximale de 15 ans, au-delà duquel le plan ne peut plus être alimenté (mais continue à produire des intérêts jusqu'à 20 ans pour les PEL ouverts avant 2011, avec des règles différentes pour les plans récents).",
      "Les intérêts des PEL ouverts depuis 2018 sont fiscalisés au PFU (flat tax, 30 %) dès la première année, contrairement aux PEL plus anciens qui bénéficiaient d'une exonération d'impôt sur le revenu pendant les 12 premières années. Son intérêt dépend donc fortement du taux garanti obtenu à l'ouverture par rapport aux taux de marché du moment.",
    ],
  ...
  },
  {
    ...
    long: [
      "Le DCA (investissement programmé) consiste à placer un montant constant à intervalle régulier (souvent mensuel), quelles que soient les conditions de marché. On achète ainsi mécaniquement plus de parts quand les prix baissent, et moins quand ils montent.",
      "Cette discipline lisse le prix de revient moyen et évite l'écueil psychologique de vouloir « attendre le bon moment » pour investir un capital important d'un coup — une stratégie qui, statistiquement, sous-performe souvent un investissement immédiat sur des marchés haussiers de long terme, mais réduit le risque de mauvais timing sur un marché volatil.",
      "C'est la stratégie naturelle de l'épargne programmée en ETF (versements mensuels automatiques sur PEA ou assurance-vie) : elle retire l'émotion de la décision d'investissement et convient particulièrement aux épargnants réguliers plutôt qu'aux détenteurs d'un capital ponctuel à placer.",
    ],
  ...
  },
  {
    ...
    long: [
      "La diversification consiste à ne pas concentrer son patrimoine sur un seul actif, secteur ou zone géographique. En combinant des placements dont les performances ne sont pas parfaitement corrélées entre elles, on réduit l'impact d'une mauvaise performance isolée sur le patrimoine global.",
      "C'est l'un des rares « repas gratuits » en finance : à rendement attendu comparable, un portefeuille diversifié réduit la volatilité globale par rapport à la somme de ses composants pris isolément.",
      "En pratique, un patrimoine diversifié combine souvent plusieurs enveloppes (PEA, assurance-vie, immobilier via SCPI ou en direct) et plusieurs classes d'actifs (actions, obligations, immobilier), plutôt qu'une seule ligne d'un seul actif — même si cet actif est lui-même un ETF « diversifié » comme un tracker World.",
    ],
  ...
  },
  {
    ...
    long: [
      "L'inflation correspond à l'augmentation moyenne des prix des biens et services. Elle réduit la valeur réelle de l'argent immobilisé : 1 000 € aujourd'hui achèteront moins de biens dans 10 ans, même sans dépense.",
      "Exemple : à une inflation moyenne de 2 %/an, un capital de 100 000 € non placé (ou placé à un rendement nul) perd environ 18 % de son pouvoir d'achat en 10 ans, et environ 33 % en 20 ans.",
      "Pour préserver son pouvoir d'achat, il faut viser un rendement supérieur à l'inflation (rendement réel positif). C'est pour cette raison que laisser une épargne de précaution excédentaire sur un compte courant ou un livret peu rémunéré représente un coût d'opportunité réel, même si le capital nominal ne baisse jamais.",
    ],
  ...
  },
  {
    ...
    long: [
      "L'effet de levier consiste à financer un investissement (souvent immobilier locatif) par l'emprunt plutôt que par un apport total en fonds propres. Si la rentabilité du bien dépasse le coût du crédit, le rendement rapporté à votre apport initial est démultiplié — c'est l'un des principaux atouts de l'immobilier locatif par rapport à un placement financier au comptant.",
      "Exemple : un bien à 200 000 € générant 4 % de rendement brut, financé à 100 % à crédit (2 000 € d'apport pour les seuls frais de dossier) plutôt qu'avec 200 000 € de fonds propres, permet de démultiplier le rendement sur le capital réellement engagé, à condition que les loyers couvrent la mensualité de crédit.",
      "Le levier amplifie les gains mais aussi les pertes en cas de vacance locative, de baisse des prix ou de hausse des taux lors d'un renouvellement : c'est un outil puissant à manier avec une marge de sécurité sur le taux d'endettement.",
    ],
  ...
  },
  {
    ...
    long: [
      "Le revenu fiscal de référence (RFR) figure sur votre avis d'imposition (case en haut de la première page). Il agrège vos revenus nets imposables et certains revenus exonérés ou soumis à un régime particulier, donnant une mesure plus large de vos ressources que le seul revenu imposable.",
      "Il conditionne l'éligibilité à de nombreux dispositifs : plafond de ressources du PTZ, exonérations de taxe foncière et de redevance audiovisuelle, bourses, et surtout le taux de CSG applicable sur les pensions de retraite (exonération, taux réduit 3,8 %, taux médian 6,6 % ou taux normal 8,3 % en 2026, selon des seuils qui varient avec le nombre de parts fiscales du foyer).",
      "Exemple : pour une personne seule (1 part), le taux médian de CSG sur les pensions s'applique en 2026 jusqu'à environ 24 800 € de RFR ; au-delà, c'est le taux normal.",
    ],
    sims: ['/simulateurs/impot-revenu', '/simulateurs/ptz', '/simulateurs/cnav'],
    related: ['ir', 'ptz', 'csg'],
  },
  {
    ...
    long: [
      "Depuis le 1er janvier 2019, l'impôt sur le revenu est prélevé à la source : l'employeur (ou la caisse de retraite, ou l'organisme versant des allocations chômage) retient l'impôt chaque mois selon un taux transmis directement par l'administration fiscale, sans que le montant du taux soit communiqué à l'employeur au-delà du chiffre lui-même.",
      "Ce taux est calculé par défaut sur les revenus déclarés l'année précédente, mais peut être individualisé (taux propre à chacun des membres d'un couple) ou modulé à la hausse ou à la baisse en cas de changement de situation (mariage, naissance, changement de revenus).",
      "Une régularisation a lieu l'année suivante après la déclaration annuelle, pour tenir compte des revenus réels, des réductions et crédits d'impôt (dons, emploi à domicile...) qui ne sont pas intégrés au taux prélevé mensuellement.",
    ],
  ...
  },
  {
    ...
    long: [
      "Le cumul emploi-retraite autorise un retraité à travailler en touchant sa pension. En cumul intégral (taux plein CNAV et tous régimes liquidés, ou 67 ans atteint), il n'y a aucun plafond de revenus cumulés.",
      "En cumul partiel (retraite anticipée sans taux plein), les revenus d'activité cumulés à la pension ne doivent pas dépasser 160 % du SMIC ou le dernier salaire d'activité perçu avant le départ — au-delà, la pension est réduite à due proportion du dépassement.",
      "Depuis la réforme de 2023, une activité reprise en cumul emploi-retraite intégral peut générer de nouveaux droits à une seconde pension (plafonnée), sous conditions — une nouveauté par rapport aux règles antérieures où les cotisations versées après liquidation ne généraient aucun droit supplémentaire.",
    ],
    sims: ['/simulateurs/cnav', '/simulateurs/retraite-progressive'],
  ...
  // ── Crédit (compléments) ────────────────────────────────────────────────────
  {
    ...
    long: [
      "Le taux d'usure est le plafond légal du TAEG qu'un établissement de crédit peut proposer. Tout crédit dont le TAEG dépasse ce seuil est considéré comme usuraire, donc illégal — la sanction peut aller jusqu'à la nullité des intérêts.",
      "Il est calculé chaque trimestre par la Banque de France à partir du Taux Effectif Moyen (TEM) réellement pratiqué par les établissements de crédit le trimestre précédent, majoré d'un tiers (33 %). Il varie selon la nature du crédit (immobilier, consommation) et sa durée.",
      "Ce mécanisme a paradoxalement pu bloquer l'accès au crédit de certains emprunteurs en période de remontée rapide des taux, le TAEG incluant l'assurance pouvant dépasser un taux d'usure qui reflète encore les taux plus bas du trimestre précédent — d'où des ajustements réglementaires ponctuels (calcul mensuel temporaire en 2023).",
    ],
    sims: ['/simulateurs/emprunt-immobilier', '/simulateurs/credit-conso'],
  ...
  },
  {
    ...
    long: [
      "Le taux nominal (ou taux débiteur) ne couvre que la rémunération du prêteur sur le capital prêté. Il sert de base au calcul des mensualités et à la répartition intérêts/capital du tableau d'amortissement, mais ne reflète pas le coût total réel du crédit.",
      "Le TAEG (Taux Annuel Effectif Global) ajoute à ce taux nominal l'assurance emprunteur, les frais de dossier et de garantie : l'écart entre les deux peut représenter 0,3 à 0,8 point selon le profil et l'assurance choisie.",
      "Pour comparer plusieurs offres de crédit entre elles, c'est toujours le TAEG qu'il faut regarder — deux prêts au même taux nominal peuvent avoir un coût total très différent selon leur assurance.",
    ],
    sims: ['/simulateurs/emprunt-immobilier', '/simulateurs/credit-conso'],
  ...
  },
  {
    ...
    long: [
      "En Coast FIRE, vous avez accumulé un capital suffisant pour qu'il croisse seul, par la seule magie des intérêts composés, jusqu'à votre objectif FIRE à l'âge de la retraite classique — sans avoir besoin d'ajouter le moindre euro d'épargne supplémentaire.",
      "Exemple : à 35 ans, avec un objectif de 750 000 € à 65 ans et un rendement réel de 5 %/an, il faut avoir déjà investi environ 173 000 € pour être en Coast FIRE (173 000 × 1,05^30 ≈ 750 000 €). En dessous de ce seuil, il faut continuer à épargner activement ; au-dessus, le capital suffit déjà.",
  ...
  // ── Épargne réglementée & immobilier (compléments) ──────────────────────────
  {
    ...
    long: [
      "Le Compte Épargne Logement (CEL) est plus souple que le PEL : versements et retraits libres à tout moment (avec un solde minimum de 300 €), plafond de versement plus bas (15 300 €), et droit à un prêt immobilier à un taux réglementé après une phase d'épargne d'au moins 18 mois.",
      "Son taux de rémunération et le taux du prêt associé sont revus deux fois par an ; les intérêts sont fiscalisés au PFU comme ceux du PEL.",
      "Il peut se cumuler avec un PEL — les droits à prêt des deux produits s'additionnent — pour préparer un achat immobilier avec un montant de prêt réglementé plus important.",
    ],
  ...
  // ── Finances / Investissement (nouveaux) ──────────────────────────────────
  {
    ...
    long: [
      "Le patrimoine net est l'indicateur central de votre situation financière : Actifs − Passifs. Actifs = liquidités, épargne de précaution, placements financiers (PEA, assurance-vie...), valeur de marché des biens immobiliers ; Passifs = capital restant dû sur les crédits en cours, autres dettes.",
      "Exemple : un propriétaire avec un bien estimé à 300 000 €, un capital restant dû de 180 000 € sur son crédit, et 40 000 € de placements financiers a un patrimoine net de 300 000 − 180 000 + 40 000 = 160 000 €. Son patrimoine brut (340 000 €) donne une image trompeuse s'il ignore la dette.",
      "Suivre son patrimoine net dans le temps (et non ses seuls actifs bruts) permet de mesurer l'évolution réelle de sa richesse, indépendamment des fluctuations de revenus ou de la valeur faciale d'un bien encore largement financé à crédit. C'est une métrique centrale dans la philosophie FIRE, où le patrimoine net investi (hors résidence principale) sert de base au calcul du capital cible.",
    ],
