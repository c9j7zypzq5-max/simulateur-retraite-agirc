...
const TXT_NAV = {
  ...
  en: {
    ...
    guidesSubtitle: "Browse by topic",
    blogSubtitle: "Articles & financial guides",
    lexiqueSubtitle: "Financial terms explained",
...
const ALL_ITEMS_FR = [
  ...
  { path: "/simulateurs/trimestres",           title: "Trimestres retraite",     subtitle: "Durée d'assurance & taux plein" },
  { path: "/simulateurs/retraite-anticipee",   title: "Retraite anticipée",      subtitle: "Carrières longues (RACL)" },
...
export const NAV_GROUPS = [
  ...
  { id: "immobilier", icon: "🏡", label: "Immobilier",  items: [
    ...
    { path: "/simulateurs/frais-notaire",       title: "Frais de notaire",       subtitle: "Neuf & ancien" },
    { path: "/simulateurs/deficit-foncier",     title: "Déficit foncier",        subtitle: "Économie d'impôt locatif" },
  ]},
  { id: "impots",     icon: "📋", label: "Impôts",      items: [
    ...
    { path: "/simulateurs/flat-tax",               title: "Flat tax / PFU",         subtitle: "31,4 % ou barème ?" },
    { path: "/simulateurs/succession",             title: "Droits de succession",   subtitle: "Barème & abattements" },
    { path: "/simulateurs/donation",               title: "Donation de son vivant", subtitle: "Droits & économie fiscale" },
  ]},
  { id: "finances",   icon: "💰", label: "Finances",    items: [
    ...
    { path: "/simulateurs/epargne-salariale",   title: "Épargne salariale",           subtitle: "PEE, PERCO, PERO" },
    { path: "/simulateurs/freelance-vs-salarie",title: "Freelance vs salarié",        subtitle: "Revenus nets comparés" },
    { path: "/simulateurs/divorce",             title: "Divorce & partage",           subtitle: "Prestation compensatoire" },
  ]},
