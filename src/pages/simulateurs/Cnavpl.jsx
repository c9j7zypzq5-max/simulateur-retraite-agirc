...
export default function Cnavpl() {
  ...
  const pensionParAge = useMemo(() => {
    ...
    return [62, 63, 64, 65, 66, 67, 68, 69, 70].map(age => ({
      x: age,
      y: calcCnavpl({ revenuAnnuel, anneesFaites, anneesRestantes, anneeNaissance, ageDépart: age }).pensionTotale,
    }));
  }, [revenuAnnuel, anneesFaites, anneesRestantes, anneeNaissance, hasResult]);
