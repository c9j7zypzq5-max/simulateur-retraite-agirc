...
import { GUIDES_LU } from "../../data/guidesLU.js";
...
export default function GuidesLU() {
  const [theme, setTheme] = useTheme();

  useEffect(() => {
    document.title = "Guides financiers luxembourgeois | simfinly.com";
    document.querySelector('meta[name="description"]')?.setAttribute("content",
      "Guides pratiques sur les finances personnelles au Luxembourg : impôt sur le revenu, retraite CNAP, droits de succession et frontaliers France-Luxembourg.");
    let link = document.querySelector('link[rel="canonical"]');
    if (!link) { link = document.createElement('link'); link.rel = 'canonical'; document.head.appendChild(link); }
    link.href = 'https://www.simfinly.com/lu/guides';
  }, []);
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <h1 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "clamp(26px, 4vw, 38px)", fontWeight: 700, color: "var(--text)", marginBottom: 12, lineHeight: 1.2 }}>
            Guides financiers — <span style={{ color: "var(--primary)" }}>Luxembourg</span>
          </h1>
          <p style={{ fontSize: 16, color: "var(--text-secondary)", lineHeight: 1.7, maxWidth: 620, margin: 0 }}>
            Des guides pratiques sur les grandes thématiques financières luxembourgeoises : impôt sur le revenu, retraite CNAP, succession et frontaliers.
          </p>
        </div>
