...
const SIMULATEURS_FR = [
  ...
  { path: "/simulateurs/comparaison-reforme", title: "Comparaison avant/après réforme 2023", desc: "Comparez votre âge de départ et votre pension selon l'ancien et le nouveau régime (réforme retraite 2023) : âge légal, trimestres requis, décote/surcote.", tag: "Retraite · Réforme", categories: ["Retraite"], badges: ["new"], available: true },
  ...
  { path: "/simulateurs/pension-reversion", title: "Pension de réversion", desc: "Estimez la réversion du conjoint survivant : 54 % de la retraite de base (CNAV) et 60 % de la complémentaire Agirc-Arrco, avec la condition de ressources.", tag: "Retraite · Conjoint survivant", categories: ["Retraite"], badges: ["new"], available: true },
  ...
  { path: "/simulateurs/ptz", title: "Prêt à Taux Zéro (PTZ)", desc: "Estimez votre PTZ primo-accédant : éligibilité, tranche de revenus, quotité et montant finançable selon votre zone et la composition du foyer. Barème 2026.", tag: "Immobilier", categories: ["Immobilier"], badges: ["new"], available: true },
  { path: "/simulateurs/frais-notaire", title: "Frais de notaire", desc: "Calculez les frais d'acquisition de votre achat immobilier : droits de mutation, émoluments du notaire, contribution de sécurité immobilière et débours, pour l'ancien et le neuf.", tag: "Immobilier", categories: ["Immobilier"], badges: ["new"], available: true },
  // Impôts
  ...
  { path: "/simulateurs/epargne-salariale", title: "Épargne salariale (PEE / PERCO)", desc: "Estimez le gain fiscal et l'économie nette de vos versements sur PEE ou PERCO grâce à l'abondement employeur et à l'exonération d'IR.", tag: "Finances · Épargne", categories: ["Finances"], badges: ["new"], available: true },
  { path: "/simulateurs/deficit-foncier", title: "Déficit foncier", desc: "Calculez l'économie d'impôt générée par vos travaux déductibles en location nue et simulez l'impact sur votre revenu foncier imposable.", tag: "Impôts · Immobilier", categories: ["Impôts", "Immobilier"], badges: ["new"], available: true },
  ...
  { path: "/simulateurs/donation", title: "Donation de son vivant", desc: "Calculez les droits de donation et comparez avec une succession. Abattements renouvelables tous les 15 ans, économie fiscale et date de renouvellement. Barème officiel 2026.", tag: "Patrimoine", categories: ["Patrimoine"], badges: ["new"], available: true },
  ...
  { path: "/simulateurs/flat-tax", title: "Flat tax / PFU 2026", desc: "Comparez le prélèvement forfaitaire unique (PFU 31,4 %) au barème progressif pour vos dividendes, plus-values et revenus de capitaux. Économie fiscale calculée selon votre TMI.", tag: "Impôts", categories: ["Impôts"], badges: ["new"], available: true },
  { path: "/simulateurs/freelance-vs-salarie", title: "Freelance vs Salarié", desc: "Comparez votre revenu net disponible selon votre statut : salarié, micro-entrepreneur BIC, micro-BNC ou portage salarial. Charges sociales, IR 2026 et comparatif complet.", tag: "Finances", categories: ["Finances"], badges: ["new"], available: true },
];
