...
export default function MentionsLegales() {
  useEffect(() => {
    ...
    document.querySelector('meta[name="description"]')?.setAttribute("content", "Mentions légales du simulateur de retraite Agirc-Arrco mesimulateurs.fr — éditeur, hébergeur, avertissement simulation.");
