...
export default function PolitiqueConfidentialite() {
  ...
  useEffect(() => {
    ...
    document.title = "Politique de confidentialité — simfinly.com";
    document.querySelector('meta[name="description"]')?.setAttribute("content", "Politique de confidentialité et cookies de simfinly.com : données collectées, Google AdSense, RGPD.");
