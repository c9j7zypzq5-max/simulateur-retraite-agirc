            ...
            {activeTab === "compare" ? (
              compareEntries ? (
                ...
                <div style={{ textAlign: "center", padding: "50px 20px" }}>
                  ...
                  <p style={{ fontSize: 14, color: "#5B6677", lineHeight: 1.7, marginBottom: 20 }}>
                    {isPro
                      ? "Revenez dans \"Mes simulations\" et sélectionnez 2 scénarios à comparer."
                      : "La comparaison de scénarios est une fonctionnalité Pro."}
                  </p>
                  {!isPro && (
                    <Link to="/pro" style={{ display: "inline-block", padding: "10px 22px", borderRadius: 10, background: "#2B5CE6", color: "#fff", textDecoration: "none", fontSize: 14 }}>
                      Découvrir Pro →
                    </Link>
                  )}
                </div>
              ...
              <>
                ...
                {!isPro && history.length >= 8 && (
                  <div style={{ background: "rgba(254,243,199,0.6)", border: "1px solid #fde68a", borderRadius: 12, padding: "12px 16px", marginBottom: 20, display: "flex", alignItems: "center", gap: 10 }}>
                    <span>⚠️</span>
                    <div>
                      <span style={{ fontSize: 13, color: "#0F1828" }}>Limite de 8 simulations atteinte. </span>
                      <Link to="/pro" style={{ fontSize: 13, color: "#b45309", textDecoration: "underline" }}>Passer à Pro pour des simulations illimitées →</Link>
                    </div>
                  </div>
                )}
                              ...
                              <div style={{ flex: 1, minWidth: 0 }}>
                                {editingId === entry.id ? (
                                  ...
                                  <div
                                    ...
                                    onDoubleClick={() => isPro && (setEditingId(entry.id), setEditValue(entry.label))}
                                    title={isPro ? "Double-cliquer pour renommer" : undefined}
                                  >
                                    {entry.label}
                                  </div>
                                )}
